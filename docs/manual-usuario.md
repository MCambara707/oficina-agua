...
| **Secretaria** | Clientes, contadores, tarifas, lecturas, recibos, pagos, ver estado de cuenta |
...
2. Presiona el botón **+ Nuevo Cliente** (o similar, arriba del listado).
...
- *"No existe una tarifa vigente válida para el tipo de este contador..."* — el contador no tiene una tarifa activa configurada para esa fecha. Avisa al Administrador para que revise la tarifa asignada.
