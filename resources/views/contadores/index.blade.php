...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="GET" action="{{ route('contadores.index') }}" class="mb-3">
                <div class="input-group" style="max-width: 400px;">
                    <input type="text" name="q" class="form-control"
                           placeholder="Buscar por número o dirección" value="{{ $busqueda }}">
            ...
            <a href="{{ route('contadores.create') }}" class="btn btn-primary mb-3">+ Nuevo Contador</a>
                ...
                <tbody>
                    @forelse ($contadores as $contador)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('contadores.edit', $contador) }}" class="btn btn-sm btn-warning">Editar</a>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center">No hay contadores registrados todavía.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
